...
import { updateUserInputSchema, type UpdateUserInputType } from "../schema/update-user-schema";
...
export const UpdateUserDialog = ({ editingUser, setEditingUser }: UpdateUserDialogProps) => {
    const {
        control,
        handleSubmit,
        reset,
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col gap-4">
                    ...
                    <SelectCustom
                        ...
                        required
                        options={[
                            { value: "1", label: "Mã phòng ban" },
                            { value: "11", label: "Tên phòng ban" },
                        ]}
