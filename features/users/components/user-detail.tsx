...
import { useUserQuery, useUsersQuery } from '../hooks'
                    ...
                    <div className="flex items-start gap-4">
                        <Avatar className="h-16 w-16">
                            ...
                            <AvatarFallback className="text-lg">
                                {user.data.fullName?.charAt(0) || user.data.userName?.charAt(0) || 'U'}
                            </AvatarFallback>
                            {/* )} */}
                        </Avatar>
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                <Badge variant={user.data.role === UserRoleEnum.ADMIN || user.data.role === UserRoleEnum.SUPER_ADMIN ? 'default' : 'outline'}>
                                    {getUserRole(user.data.role)}
                                </Badge>
                                <Badge
                                    variant={user.data.isVerifiedAccount ? 'default' : 'destructive'}
                                >
