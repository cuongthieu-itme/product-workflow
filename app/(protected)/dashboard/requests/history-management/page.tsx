    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="mt-8">
        ...
        <div className="prose max-w-none">
          <p>
            Collection lịch sử (<code>requestHistory</code>) được sử dụng để lưu
            trữ tất cả các thay đổi liên quan đến yêu cầu trong hệ thống. Điều
            này giúp theo dõi ai đã thực hiện thay đổi gì và khi nào.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>action</strong>: Loại hành động (create, update, delete,
              revert, complete, reject, hold)
            </li>
            <li>
              <strong>entityType</strong>: Loại đối tượng bị thay đổi (request,
              workflow, step, material, comment)
            </li>
            <li>
              <strong>entityId</strong>: ID của đối tượng bị thay đổi
            </li>
            <li>
              <strong>changes</strong>: Chi tiết các thay đổi (trường, giá trị
              cũ, giá trị mới)
            </li>
            <li>
