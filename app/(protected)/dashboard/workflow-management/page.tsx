              ...
              <div className="container mx-auto py-6 space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Thiết lập và quản lý quy trình chuẩn và quy trình con cho
                    các trạng thái sản phẩm khác nhau.
                  </p>
                </div>
                ...
                >
                  <TabsList className="grid w-full grid-cols-2">
                    ...
                    <TabsTrigger value="sub-workflows">
                      Quy trình con
                    </TabsTrigger>
                  </TabsList>
                  <TabsContent value="standard" className="space-y-4 mt-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Thiết lập quy trình chuẩn cho tất cả sản phẩm. Quy
                          trình chuẩn sẽ được sử dụng làm cơ sở cho các quy
                          trình con.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                  ...
                  <TabsContent value="sub-workflows" className="space-y-4 mt-4">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Quản lý các quy trình con cho từng trạng thái sản phẩm
                          cụ thể. Quy trình con được tạo dựa trên quy trình
                          chuẩn.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
