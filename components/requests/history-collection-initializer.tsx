...
export function HistoryCollectionInitializer() {
  const [status, setStatus] = useState<
    'checking' | 'exists' | 'initialized' | 'error'
  >('checking')
    ...
    return (
      <Alert className="bg-green-50 border-green-200">
        ...
        <AlertTitle className="text-green-800">
          Collection lịch sử đã sẵn sàng
        </AlertTitle>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Collection lịch sử chưa tồn tại hoặc chưa được khởi tạo đúng cách. Bạn
          cần khởi tạo collection này để có thể lưu trữ lịch sử thay đổi.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Alert variant="warning">
          ...
          <AlertDescription>
            Hệ thống không thể tìm thấy collection lịch sử trong cơ sở dữ liệu.
            Vui lòng khởi tạo để đảm bảo tính năng lịch sử hoạt động đúng.
          </AlertDescription>
        </Alert>
      </CardContent>
      <CardFooter>
