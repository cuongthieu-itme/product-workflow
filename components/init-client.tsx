      ...
      try {
        ...
        if (!navigator.onLine) {
          ...
          toast({
            ...
            description:
              'Ứng dụng đang chạy ở chế độ ngoại tuyến. Dữ liệu sẽ được đồng bộ khi có kết nối.',
            variant: 'warning'
          })
          return
        }
        ...
        toast({
          ...
          description:
            'Đã xảy ra lỗi khi khởi tạo dữ liệu. Một số tính năng có thể không hoạt động đúng.',
          variant: 'destructive'
        })
      }
    }
