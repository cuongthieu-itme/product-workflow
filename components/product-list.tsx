...
import { Eye, CheckCircle2, FileEdit, Palette, ShoppingCart, Megaphone, Rocket } from "lucide-react"
...
export default function ProductList({ filterStatus }: { filterStatus?: "active" | "completed" }) {
