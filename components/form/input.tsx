  ...
  return (
    ...
    <div className="space-y-1">
      <BaseInput
        ...
        required={required}
        disabled={disabled}
        className={`w-full ${className} ${fieldState.error ? 'border-red-500 placeholder:text-red-500 focus-visible:placeholder:text-red-500 focus-visible:border-red-500' : ''}`}
        {...props}
      />
      {fieldState.error && (
