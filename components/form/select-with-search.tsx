...
export type SelectWithSearchProps<T extends FieldValues> =
...
export const SelectWithSearch = <T extends FieldValues>({
  name,
  control,
  defaultValue,
  rules,
  ...
  const handleSelect = (selectedValue: string) => {
    if (selectedValue === KEY_EMPTY_SELECT) {
      ...
      onChange(valueType === "number" ? Number(selectedValue) : selectedValue);
    }
    setOpen(false);
    setSearchValue("");
  };
          ...
          <PopoverTrigger asChild>
            ...
            >
              ...
              <div className="flex items-center gap-1">
                {clearable &&
                  selectedOption &&
                  selectedOption.value !== KEY_EMPTY_SELECT && (
                    <X
