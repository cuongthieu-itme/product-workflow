...
import { Loader2, AlertCircle, User, Mail, Building, Shield, Phone, FileText } from "lucide-react"
    ...
    const fetchCurrentUser = async () => {
      if (typeof window !== "undefined") {
        try {
          ...
          console.log("Thông tin từ localStorage:", { username, userRole, userDepartment })
          ...
          console.log(
            "Tất cả người dùng:",
            allUsers.map((u) => ({ id: u.id, username: u.username, department: u.department })),
          )
          ...
          if (username.toLowerCase() === "admin" && !foundUser) {
            foundUser = allUsers.find((user) => user.username?.toLowerCase() === "admin")
          }
          ...
          if (foundUser) {
            ...
            if (foundUser.department && foundUser.department !== userDepartment) {
            ...
            console.log("Thông tin đăng nhập từ localStorage:", { username, userRole, userDepartment })
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userId) {
        ...
        localStorage.setItem("username", profileData.fullName || profileData.username)
              ...
              <CardContent className="space-y-6">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    <h3 className="text-xl font-semibold">{profileData.fullName || profileData.username}</h3>
                ...
                <form onSubmit={handleProfileSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input id="username" value={profileData.username} disabled className="bg-muted" />
                      ...
                      >
                        <SelectTrigger id="department">
                          <SelectValue placeholder="Chọn phòng ban">
                            {departmentNames[profileData.department] || profileData.department || "Chọn phòng ban"}
                          </SelectValue>
                        </SelectTrigger>
                        <SelectContent>
