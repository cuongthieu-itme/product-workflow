...
import {
  migrateWorkflowsToSubWorkflows,
  deleteWorkflowsCollection
} from '@/lib/migrate-workflows'
...
export function MigrateWorkflows() {
  ...
  const [step, setStep] = useState<'initial' | 'migrated' | 'deleted'>(
    'initial'
  )
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Di chuyển dữ liệu từ collection workflows sang subWorkflows và xóa
          collection workflows cũ
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {step === 'initial' && (
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Hãy đảm bảo bạn đã sao lưu dữ liệu trước khi thực hiện di
                chuyển. Quá trình này không thể hoàn tác.
              </AlertDescription>
            </Alert>

            <div className="bg-muted p-4 rounded-md">
              <h3 className="font-medium mb-2">
                Quá trình di chuyển sẽ thực hiện:
              </h3>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Di chuyển dữ liệu từ collection workflows sang subWorkflows
                </li>
        ...
        {step === 'migrated' && (
          <div className="space-y-4">
            <Alert variant="success">
              ...
              <AlertDescription>
                Dữ liệu đã được di chuyển từ collection workflows sang
                subWorkflows. Bạn có thể xóa collection workflows cũ.
              </AlertDescription>
            </Alert>
            ...
            <div className="bg-muted p-4 rounded-md">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  Đảm bảo tất cả các component đã được cập nhật để sử dụng API
                  mới
                </li>
              </ul>
            </div>
        ...
        {step === 'deleted' && (
          <Alert variant="success">
            ...
            <AlertDescription>
              Quá trình di chuyển dữ liệu và xóa collection workflows cũ đã hoàn
              tất. Hệ thống đã sẵn sàng sử dụng API mới.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
