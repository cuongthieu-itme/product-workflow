    ...
    <div className="space-y-4">
      {resetSuccess ? (
        <Alert className="bg-green-50 border-green-200">
          ...
          <AlertDescription>
            Quy trình chuẩn đã được khởi tạo lại thành công. Vui lòng làm mới
            trang để xem các thay đổi.
          </AlertDescription>
          <div className="mt-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Bạn có chắc chắn muốn khởi tạo lại quy trình chuẩn? Hành động này
              sẽ xóa quy trình chuẩn hiện tại và tạo lại với các bước mặc định.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Hành động này không thể hoàn tác. Tất cả các thay đổi bạn đã
                thực hiện với quy trình chuẩn sẽ bị mất.
              </AlertDescription>
            </Alert>
          </CardContent>
